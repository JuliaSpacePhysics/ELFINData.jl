---
name: elfindata
description: Access and process ELFIN mission data (electron flux, magnetometer, spacecraft state). Use this skill for fetching ELFIN data, working with EPD spectra, querying ELA/ELB instruments or analyzing pitch-angle distributions in Julia.
---
